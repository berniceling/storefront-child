...
<div id="page" class="hfeed site">
	...
	<div class="wrap">
	<?php echo do_shortcode("[metaslider id=59732 percentwidth=100]"); ?>				
	<div id='pm' class='inside'><?php wp_nav_menu( array('theme_location' => 'spill-menu', 'container_id' => 'cssmenu')); ?></div>
	</div><!-- wrap -->
	<?php
	/**
