...
<form method="post" class="lost_reset_password">
	...
	<?php if( 'lost_password' == $args['form'] ) : ?>
		...
		<p class="form-row form-row-first"><label for="user_login"><?php _e( 'Email', 'woocommerce' ); ?></label> <input style='border-bottom: 1px solid #C8C8C8;' class="input-text" type="text" name="user_login" id="user_login" /></p>
