...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	<div class="col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> address">
		<header class="title">
			...
			<a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="edit"><?php _e( 'Edit Address/iLok ID', 'woocommerce' ); ?></a>
		</header>
		<address>
			<?php
				...
				if ( ! $formatted_address )
					...
					// add ilok info
					$ilokId= get_user_meta( $customer_id, $name . '_ilok_id', true );
					$formatted_address .= "<br/>iLok ID : " . $ilokId . "<br/>";
