...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner" <?php if ( get_header_image() != '' ) { echo 'style="background-image: url(' . esc_url( get_header_image() ) . ');"'; } ?>>
			<?php global $current_user;
				  ...
				  $edit_url = get_settings('siteurl').'/store/my-account';
				...
				if ( is_user_logged_in() ) { ?>
						...
						<div class='header_login_wrapper'>
							<span id='loggedIn_email' class='header_login'><?php echo $email;?></span><span class='header_login'><a href=<?php echo $edit_url;?>>My Account</a></span>
